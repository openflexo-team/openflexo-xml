...
/**
 * An abstract {@link PamelaModelFactory} used to manage both {@link FreeXMLDocument} and {@link XMLModel}
 * 
 * @author sylvain
 * 
 */
public class AbstractXMLDocumentFactory<R extends XMLResource<RD> & PamelaResource<RD, ?>, RD extends AbstractXMLDocument<RD>>
	...
	private static final Logger logger = Logger.getLogger(AbstractXMLDocumentFactory.class.getPackage().getName());
	...
	public AbstractXMLDocumentFactory(PamelaMetaModel metaModel, R resource, EditingContext editingContext)
