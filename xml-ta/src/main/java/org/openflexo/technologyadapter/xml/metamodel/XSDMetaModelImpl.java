...
public abstract class XSDMetaModelImpl
		// extends XMLMetaModelImpl<XSDMetaModel> implements XSDMetaModel {
		// public abstract class XSDMetaModelImpl extends XSOntology implements XMLMetaModel {

		extends AbstractXMLDocumentImpl<XSDMetaModel> implements XSDMetaModel {
	...
	public XMLType createNewType(String uri, String localName, boolean simpleType) {
		...
		XMLType aType = null;
		if (simpleType) {
			aType = getFactory().newInstance(XMLSimpleType.class, this);
		}
		else {
			aType = getFactory().newInstance(XMLComplexType.class, this);
		}
