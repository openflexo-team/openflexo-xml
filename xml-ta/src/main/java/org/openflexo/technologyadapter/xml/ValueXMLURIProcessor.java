...
/**
 * URI processor that resolves objects using normalized data values.
 *
 * This is useful when the source id changed but the object still contains
 * recognizable values.
 */
@ModelEntity
@XMLElement
@ImplementationClass(ValueXMLURIProcessor.ValueXMLURIProcessorImpl.class)
public interface ValueXMLURIProcessor extends XMLURIProcessor {

    public static abstract class ValueXMLURIProcessorImpl
            extends AbstractSignatureXMLURIProcessor
            implements ValueXMLURIProcessor {

        private static final double VALUE_THRESHOLD = 0.82;

        /**
         * Builds a URI using normalized value information.
         *
        ...
        public String getURIForObject(XMLModel model, XMLObject object) {
            if (!(object instanceof XMLIndividual)) {
                logger.warning("Cannot build value URI: object is not an XMLIndividual");
                return null;
            }
            ...
            if (getMappedXMLType() == null || typeURI == null) {
                logger.warning("Cannot build value URI: processor is not initialized");
                return null;
            }
        ...
        /**
         * Resolves an object by normalized value similarity.
         *
        ...
        public Object retrieveObjectWithURI(XMLModel model, String objectURI)
            ...
            XMLIndividual resolved = resolveByValue(model, parameters, VALUE_THRESHOLD);
