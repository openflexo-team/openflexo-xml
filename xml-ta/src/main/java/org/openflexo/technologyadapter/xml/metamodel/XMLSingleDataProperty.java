...
/**
 * An {@link XMLDataProperty} with a single cardinality
 * 
 * @author sylvain
 *
 */
@ModelEntity
@ImplementationClass(XMLSingleDataProperty.XMLSingleDataPropertyImpl.class)
public interface XMLSingleDataProperty<T> extends XMLDataProperty<T>, XMLSingleProperty<XMLSimpleType, T> {

	public static final String DEFAULT_VALUE_KEY = "defaultValue";
	public static final String FIXED_VALUE_KEY = "fixedValue";

	@Initializer
	public XMLSingleDataProperty<T> init(@Parameter(NAME) String s, @Parameter(TYPE_KEY) XMLSimpleType type);
	...
	/**
	 * Default implementation for {@link XMLSingleDataProperty}
	 */
	public static abstract class XMLSingleDataPropertyImpl<T> extends XMLDataPropertyImpl<T> implements XMLSingleDataProperty<T> {
		...
		public String getDisplayableDescription() {
			StringBuffer buffer = new StringBuffer("XMLSingleDataProperty ");
