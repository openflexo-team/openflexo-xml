...
public class TestFMLEditorWithXMLTA extends OpenflexoFIBTestCase {
	...
	public void loadFMLResource() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		assertNotNull(vpLib);
		VirtualModel virtualModel = vpLib.getVirtualModel("http://mem4csd.telecom-paris.fr/OtawaPipeline/TestOtawa.fml");
	...
	public static void initGUI() {
		gcDelegate = new SwingGraphicalContextDelegate(TestFMLEditorWithXMLTA.class.getSimpleName());
	}
